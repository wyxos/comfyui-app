...
watch(() => ({
  ...
  clipSkip: state.clipSkip.value,
  flattenInputImageBackground: state.flattenInputImageBackground.value,
  height: state.height.value,
  hiresCfg: state.hiresCfg.value,
  hiresDenoise: state.hiresDenoise.value,
  hiresEnabled: state.hiresEnabled.value,
  hiresHeight: state.hiresHeight.value,
  hiresSamplerName: state.hiresSamplerName.value,
  hiresScheduler: state.hiresScheduler.value,
  hiresSteps: state.hiresSteps.value,
  hiresUpscale: state.hiresUpscale.value,
  hiresUpscaler: state.hiresUpscaler.value,
  hiresWidth: state.hiresWidth.value,
